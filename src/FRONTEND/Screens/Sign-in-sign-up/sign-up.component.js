...
import {getUserByEmail, getUserByUsername} from "../../../BACKEND/Services/UsersServices";
...
const SignUp = () => {
    ...
    const handleContinue = (e) => {
        e.preventDefault();
        let check_un;
        getUserByEmail(email.current.value).then(r => {
            check_un = r;
        })
        if (check_un) {
    ...
    return (
        <form className="f-form d-flex flex-column align-items-center justify-content-center " ref={form} onSubmit={handleContinue}>
